...
class WaresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ware" do
    assert_difference('Ware.count') do
      post wares_url, params: { ware: { wdesc: @ware.wdesc, wfactory: @ware.wfactory, wimg: @ware.wimg, wname: @ware.wname, wprice: @ware.wprice, wtype: @ware.wtype } }
    end
  ...
  test "should update ware" do
    patch ware_url(@ware), params: { ware: { wdesc: @ware.wdesc, wfactory: @ware.wfactory, wimg: @ware.wimg, wname: @ware.wname, wprice: @ware.wprice, wtype: @ware.wtype } }
